...
const slides = [
  ...
  },
  {
    ...
    title: '句子含义：表层 + 深层 + 生活',
    type: 'compare',
    leftTitle: '通用两步：表层 + 深层',
    left: ['① 表层：字面上写了什么', '② 深层：联系上下文、主旨、情感', '比喻句先找本体和喻体，双关句先解释本义'],
    rightTitle: '结合生活经验（三步）',
    right: ['① 表面：这句话表面上是说……', '② 深层：实际上告诉我们……（提炼道理/主旨）', '③ 生活：在生活中，我也曾遇到过……（举例说明）'],
    formula: '通用：先说字面意思，再说文中真正表达了什么。\n问“结合生活经验”时补第三步：联系生活实例。',
    note:
      '句子含义题最怕只翻译字面意思。尤其是比喻句、双关句、哲理句，要把隐藏意思说出来。如果题干有“结合生活经验说一说”，答案要变成三步：表面含义 → 深层道理 → 生活实例，缺一不可。'
  },
  {
    eyebrow: '高频题型',
